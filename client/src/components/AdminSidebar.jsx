...
export default function AdminSidebar({ isOpen, onClose }) {
    ...
    return (
        <aside className={`w-72 bg-slate-900 border-r border-slate-800 flex flex-col fixed h-screen z-30 shadow-2xl text-slate-300 transition-transform duration-300 md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
            {/* Brand */}
